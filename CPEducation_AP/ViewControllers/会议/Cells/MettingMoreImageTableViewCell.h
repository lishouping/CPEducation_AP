//
//  MettingMoreImageTableViewCell.h
//  CPEducation_AP
//
...
@interface MettingMoreImageTableViewCell : UITableViewCell
...
@property(nonatomic,strong)UIImageView *imgNotice1;
@property(nonatomic,strong)UIImageView *imgNotice2;
@end
