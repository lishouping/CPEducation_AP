//
//  InfoDeatledMoreImgViewController.m
//  CPEducation_AP
//
...
@interface InfoDeatledMoreImgViewController ()
...
@implementation InfoDeatledMoreImgViewController
...
-(void)loadDate{
    ...
    [manager POST:postUrl parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([[responseObject objectForKey:@"code"] isEqualToString:@"1000"]) {
            ...
            SDCycleScrollView *cycleScrollView2 = [SDCycleScrollView cycleScrollViewWithFrame:CGRectMake(0, 0, kWidth, 180) delegate:self placeholderImage:[UIImage imageNamed:@"placeholder"]];
