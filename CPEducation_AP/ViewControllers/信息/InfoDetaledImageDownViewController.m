//
//  InfoDetaledImageDownViewController.m
//  CPEducation_AP
//
...
@interface InfoDetaledImageDownViewController ()
...
@implementation InfoDetaledImageDownViewController
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if ([tableView isEqual:tableViewAnnex]) {
        ...
        NSString *filename = [NSString stringWithFormat:@"/信息-%@%@", title, [[self.dateArray objectAtIndex:indexPath.row] objectForKey:@"filename"]] ;
