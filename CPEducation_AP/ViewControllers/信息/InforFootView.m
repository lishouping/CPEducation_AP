...
- (void)setup{
    ...
    UIImageView *imgviews = [[UIImageView alloc] initWithFrame:CGRectMake(kWidth-30-20, 9, 11, 7)];
    [imgviews setImage:[UIImage imageNamed:@"ic_liulan"]];
    [footView addSubview:imgviews];
    
    self.labNoticeReadNum = [[UILabel alloc] initWithFrame:CGRectMake(kWidth-8-20-10, 5, 30, 15)];
    ...
    self.labNoticeFabulous.hidden = YES;
