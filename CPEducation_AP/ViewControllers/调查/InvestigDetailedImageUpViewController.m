//
//  InvestigDetailedImageUpViewController.m
//  CPEducation_AP
//
...
@interface InvestigDetailedImageUpViewController ()
...
@implementation InvestigDetailedImageUpViewController
...
-(void)loadDate{
    ...
    [manager POST:postUrl parameters:parameters success:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        if ([[responseObject objectForKey:@"code"] isEqualToString:@"1000"]) {
            ...
            tabViewImg = [[UITableView alloc] initWithFrame:CGRectMake(0, expectSize.height+expectSize1.height+10+10+30, kWidth, tableHight)];
            ...
            labNoticeContent.frame = CGRectMake(10, expectSize.height+expectSize1.height+tableHight+60, kWidth-10-10, expectSize2.height);
